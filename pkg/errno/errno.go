...
var (
	...
	ErrGenerate         = &Errno{Code: 10005, Message: "Error occurred while generate token"}
	ErrParse            = &Errno{Code: 10006, Message: "Error occurred while parse token"}
	...
	ErrNotJoined        = &Errno{Code: 20007, Message: "User not join any team."}
